...
Public Class rptVentasPorFecha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GestionTextiles.rptVentasPorFecha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasPorFecha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasPorFecha = New rptVentasPorFecha()
        rpt.Site = Me.Site
        Return rpt
    End Function
