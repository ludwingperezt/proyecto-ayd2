...
Public Class CierreDeCajaFinal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GestionTextiles.CierreDeCajaFinal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCierreDeCajaFinal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CierreDeCajaFinal = New CierreDeCajaFinal()
        rpt.Site = Me.Site
        Return rpt
    End Function
