...
Public Class frmEliminarFacturaProveedor
    ...
    Private Sub frmEliminarFacturaProveedor_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.txtNit.Text = "" 'falta funcion para obtener datos de encabezado de factura
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        ...
        Try
            If MessageBox.Show("¿Está seguro que desa desactivar al proveedor: " + frmModuloProveedores.gnpProveedor.getEmpresa() + ", de la base de datos?", "Atención", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                sMensaje = frmModuloCompras.gnpComprasSeleccionado.fnsDevolverFacturaProveedor(sAnotacion)
